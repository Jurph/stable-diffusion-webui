...
def check_access():
    assert not shared.cmd_opts.disable_extension_access, "Extension updates are disabled when the UI is remotely accessible. Restart without the --listen or --share command line options and try again."
